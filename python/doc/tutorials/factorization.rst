...
.. code:: python
    ...
    sns.set_style('white')
    plt.imshow(imgs[0,:,:,0].T, clim=(-0.05,0.05));
...
.. code:: python
    ...
    plt.imshow(imgs[1,:,:,0].T, clim=(-0.05,0.05));
...
.. code:: python
    ...
    sns.set_style('white')
    plt.imshow(amax(maps,2).transpose(1,0,2));
...
.. code:: python
    ...
    sns.set_style('white')
    plt.imshow(imgs[0][:,:,0].T, cmap='gray');
...
.. code:: python
    ...
    plt.imshow(imgs[1][:,:,0].T, cmap='gray');
...
.. code:: python
    ...
    plt.imshow(imgs[2][:,:,0].T, cmap='gray');
...
.. code:: python
    ...
    plt.imshow(maps[:,:,0,:].transpose(1,0,2));
