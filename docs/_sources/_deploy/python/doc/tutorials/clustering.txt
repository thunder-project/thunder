...
.. code:: python
    ...
    sns.set_style('white')
    plt.imshow(img_labels[:,:,0], cmap=cmap_cat);
...
.. code:: python
    ...
    brainmap = Colorize(toType=cmap_cat).images(img_labels[:,:,0])
    plt.imshow(brainmap);
...
.. code:: python
    ...
    sns.set_style('white')
    brainmap = Colorize(toType=newclrs).images(img_labels[:,:,0])
    plt.imshow(brainmap);
...
.. code:: python
    ...
    plt.imshow(img_sim[:,:,0], cmap='gray',clim=(0,1));
...
.. code:: python
    ...
    brainmap = Colorize(toType=newclrs).images(img_labels[:,:,0], mask=img_sim[:,:,0])
    plt.imshow(brainmap);
